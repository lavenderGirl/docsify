[小程序开发指南](https://developers.weixin.qq.com/ebook?action=get_post_info&docid=0008aeea9a8978ab0086a685851c0a) | [微信小程序官网](https://developers.weixin.qq.com/miniprogram/dev/framework/)

如果对小程序一点都不熟悉的话，可以先到官网看文档熟悉熟悉，这里主要是我在看官网文档做项目的过程中的一些记录，也是自己对基础知识的一个巩固，会不断完善。

### 一、微信开发者工具 [下载请点击](https://developers.weixin.qq.com/miniprogram/dev/devtools/download.html)
  - 如果小程序要求兼容到iOS8以下版本，需要开启样式自动补全。开启样式自动补全，在“设置”—“项目设置”—勾选“上传代码时样式自动补全”。
  - 右击目录选择“新建pages和新建component”会自动生成对应页面
  - 想看哪个页面，就可以把app.json中pages里的那个页面路径移到第一个就可以
  - 编译里可对页面设置参数
  - 点击“上传”可上传到微信小程序后台管理以进行发布体验版或者正式版等。
